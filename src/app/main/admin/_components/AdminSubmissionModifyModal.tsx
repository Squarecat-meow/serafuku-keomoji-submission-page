...
import AdminSubmissionModifyConfirmModal from "./AdminSubmissionModifyConfirmModal";
...
export default function AdminSubmissionModifyModal({
  data,
  isVisible,
  onModifyVisible,
}: {
  ...
  const status = useAdminSidebarStore((state) => state.type);
  const mutation = useMutation(
    adminQueries.adminSubmissionModifyOptions(
      queryClient,
      status,
      onModifyVisible,
      setChildren,
  ...
  return (
    <Modal isVisible={isVisible} setIsVisible={onModifyVisible}>
      ...
      <AdminSubmissionModifyConfirmModal
